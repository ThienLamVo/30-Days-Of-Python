...
for country in countries:
    for language in country['languages']:
        if language not in unique_languages:
            ...
            unique_languages[language] += 1
print(f'Total number of unique languages is {len(unique_languages)}') 
largest_language = ''
largest_language_size = 0
for i in range(10):
    for language in unique_languages:
        if unique_languages[language] > largest_language_size:
            largest_language_size = unique_languages[language]
            largest_language = language
    print(f'{largest_language} with size: {largest_language_size}')
    del unique_languages[largest_language]
    largest_language_size = 0
...
for country in countries:
    if country['population'] not in populations:
